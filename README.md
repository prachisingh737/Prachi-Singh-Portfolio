# Prachi Singh - Data Analyst Portfolio
## About
Hi, I'm Prachi Singh! My passion for data analytics started with a curiosity about finding patterns and insights in data, which has grown into a strong ability to analyze and visualize complex information. At GEP Worldwide, I honed my skills by improving workflows and uncovering key insights, using tools like SQL, Python, Power BI, and Tableau to solve problems effectively.

I’ve worked on impactful projects, including building a dashboard for Toman Bike Share to track performance metrics and developing machine learning models to streamline veterinary care decisions. Currently pursuing my Master’s at Pace University, I’m sharpening my expertise in data modeling, statistical analysis, and visualization, driven by a love for tackling challenges and using data to guide meaningful decisions.
...
## Contacts
- LinkedIn:(https://www.linkedin.com/in/prachi-singh-b334301b8/))
- Email: prachisingh.contact@gmail.com
